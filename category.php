...
<section class="page-hero">
	<div class="container">
		...
		<p class="page-hero__intro">Sharing what I've learned the hard way &mdash; fixes for the stuff that breaks, shortcuts for the stuff that shouldn't take as long as it does, and the tools that actually earn a spot in my workflow.</p>
	</div>
</section>
